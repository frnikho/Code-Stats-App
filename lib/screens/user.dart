              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text("${user.total_xps} ", style: defaultTextStyle),
                            Text("xp", style: defaultTextStyle.copyWith(fontSize: 30)),
                          ],
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            ...
                            Text("xp today", style: defaultTextStyle.copyWith(fontSize: 24)),
                          ],
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Text("Languages", style: TextStyle(fontFamily: "Rubik-Light", fontSize: 26, fontWeight: FontWeight.w600))
                  ),
                  Container(
